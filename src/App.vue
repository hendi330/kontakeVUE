...
async function HTML_to_pdf(userIDS){
   ...
   for(let i = 0; i < users.length; i++){
      ...
      list.appendChild(create_li_element("Vorname", users[i].personalinfo_firstname));
      list.appendChild(create_li_element("Nachname", users[i].personalinfo_lastname));
      ...
      list.appendChild(create_li_element("EMail", users[i].personalinfo_email));
      list.appendChild(create_li_header_element("AdressInfos"));
      list.appendChild(create_hr_element());
      list.appendChild(create_li_element("Stadt", users[i].location_city +", "+ users[i].location_zipcode));
      list.appendChild(create_li_element("Straße", users[i].location_street + ", " + users[i].location_housenumber));
      tmp_div.appendChild(create_img_elemet(users[i].personalinfo_pic));
      tmp_div.appendChild(list);
      tmp_div.appendChild(create_img_elemet("../../public/andersbild.jpg"));
